        ...
        <div class="row g-3">
            ...
            <div class="col-md-4">
                ...
                <select class="form-select detalle-required"
                        id="id_categoria_reductor"
                        name="id_categoria_reductor">
            ...
            <!-- Tipo de daño -->
            <div class="col-md-4">
                <label for="id_tipo_danio" class="form-label fw-semibold">
                    Tipo de daño
                </label>
                ...
                <select class="form-select detalle-required"
                    ...
                    <?php foreach ($catalogos['tipos_danio_reductor'] as $danio) { ?>
                        <option
                            value="<?php echo $danio['id_tipo_danio']; ?>"
